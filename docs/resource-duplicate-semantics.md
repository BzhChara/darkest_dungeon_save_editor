...
Current CSV mapping and JSON inheritance ambiguity/script checks remain conservative. This integration does not settle every duplicate curio interaction, effect, inheritance override or scripted resource behavior. Auto-sync still detects file-content changes without a manifest edit and rebinds current guards; preparation and commit recheck effective sources. Props continue to use hashes without Bridge activation or encounter reindexing.
