...
Last reviewed: 2026-09-05. Historical probes below establish particular engine contracts; they do not require users to repeat the old manual Bridge installation/removal workflow.
...
- write standalone curio/treasure, trap, obstacle, ambush-composite, or unresolved named/scripted encounter replacements. Ordinary room-battle curio/treasure attachments and bilingual encounter localization are already implemented;
